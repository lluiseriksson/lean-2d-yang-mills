...
amplitude.  The schedule is hidden from the public loop object,
...
in the Lean development.  Printing axioms for the thirty-four audited public endpoints
...
edge integral by a formal lattice gauge-fixing change of variables.

It does not yet generalize that unreduced equivalence to every finite
cellulation.  It also does not identify the
