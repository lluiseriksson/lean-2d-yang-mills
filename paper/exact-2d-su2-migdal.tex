...
for one vertex of arbitrary finite valence.  The schedule is hidden from the public loop object,
...
fixed-valence limitation of the gauge step.  They do not yet compose the local
steps at all vertices of a general disk or identify the transformed holonomy of
every face; those are separate combinatorial statements about a chosen
spanning tree.
...
in the Lean development.  Printing axioms for the thirty-eight audited public endpoints
...
It does not yet compose the local gauge steps along a spanning tree of every
finite cellulation or identify all transformed face holonomies.  It also does not identify the
